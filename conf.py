...
BLOG_AUTHOR = "Burak Arslan"  # (translatable)
BLOG_TITLE = "Spyne Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://spyne.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
BASE_URL = "http://spyne.io/blog/"

BLOG_EMAIL = "burak+blog@spyne.io"
BLOG_DESCRIPTION = "This is the development blog for the Spyne project."  # (translatable)
...
#GITHUB_SOURCE_BRANCH = 'blog-source'
